...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="relative py-24 lg:py-32 bg-surface-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          {localizedServices.map((service, i) => {
            ...
            <ScrollReveal key={service.title} delay={i * 0.1}>
              <Link to="/consult" className="block h-full group">
                <div className="relative rounded-2xl p-6 h-full border border-line bg-surface-2 hover:bg-surface-3 transition-all hover:-translate-y-1">
                  ...
                  <div className="relative">
                    ...
                    <h3 className={`text-lg font-bold text-ink mb-2 ${tone.title} transition-colors`}>
                      {service.title}
                    </h3>
        ...
        <ScrollReveal delay={0.3}>
          <div className="mt-10">
            <Link
              to="/consult"
              className="group block rounded-2xl border border-line bg-surface-2 p-8 lg:p-10 hover:border-brand-200 hover:bg-brand-50 transition-all"
            >
